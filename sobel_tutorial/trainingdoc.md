...
We see that the co-simulation took 2,088,213 clock cycles to finish. The
...
+--------------+---------------+-------------+-------------+----------+-------------+
| clk          | 10.000 ns     | 100.000 MHz | 8.006 ns    | 1.994 ns | 501.505 MHz |
+--------------+---------------+-------------+-------------+----------+-------------+
...
+--------------------------+---------------+--------+------------+
| Fabric + Interface 4LUT* | 617 + 0 = 617 | 108600 | 0.57       |
| Fabric + Interface DFF*  | 339 + 0 = 339 | 108600 | 0.31       |
| User I/O                 | 0             | 284    | 0.00       |
| uSRAM                    | 0             | 1008   | 0.00       |
| LSRAM                    | 0             | 352    | 0.00       |
| Math                     | 0             | 336    | 0.00       |
...
```
# sobel_filter_top execution time (cycles):     1048582
# Number of calls:           1
# sobel_filter_top simulation time (cycles):     1048584
# ** Note: $finish    : cosim_tb.sv(434)
#    Time: 10485945 ns  Iteration: 1  Instance: /cosim_tb
# End time: 15:55:08 on Aug 05,2026, Elapsed time: 0:00:16
# Errors: 0, Warnings: 0
Info: Verifying RTL simulation
Retrieving hardware outputs from RTL simulation for sobel_filter function call 1.
PASS!
...
+------------------+-----------------+--------------------------+----------------------------+-----------------------+
| sobel_filter_top | 1               | 1,048,584                | 1,048,582 (single call)    | N/A (single call)     |
+------------------+-----------------+--------------------------+----------------------------+-----------------------+
Simulation time (cycles): 1,048,584
SW/HW co-simulation: PASS

```

Observe that loop pipelining has dramatically improved the cycle latency
for the design, reducing it from 2,088,213 cycles to 1,048,584  cycles in
total.
...
| Clock Domain | Target Period | Target Fmax | Worst Slack | Period   | Fmax        |
+--------------+---------------+-------------+-------------+----------+-------------+
| clk          | 10.000 ns     | 100.000 MHz | 6.942 ns    | 3.058 ns | 327.011 MHz |
+--------------+---------------+-------------+-------------+----------+-------------+
...
| Resource Type            | Used          | Total  | Percentage |
+--------------------------+---------------+--------+------------+
| Fabric + Interface 4LUT* | 818 + 0 = 818 | 108600 | 0.75       |
| Fabric + Interface DFF*  | 349 + 0 = 349 | 108600 | 0.32       |
| User I/O                 | 0             | 284    | 0.00       |
| uSRAM                    | 0             | 1008   | 0.00       |
| LSRAM                    | 0             | 352    | 0.00       |
| Math                     | 0             | 336    | 0.00       |
...
| Clock Domain | Target Period | Target Fmax | Worst Slack | Period   | Fmax        |
+--------------+---------------+-------------+-------------+----------+-------------+
| clk          | 10.000 ns     | 100.000 MHz | 5.456 ns    | 4.544 ns | 220.070 MHz |
+--------------+---------------+-------------+-------------+----------+-------------+
...
| Resource Type            | Used           | Total  | Percentage |
+--------------------------+----------------+--------+------------+
| Fabric + Interface 4LUT* | 637 + 36 = 673 | 108600 | 0.62       |
| Fabric + Interface DFF*  | 497 + 36 = 533 | 108600 | 0.49       |
| User I/O                 | 0              | 284    | 0.00       |
| uSRAM                    | 0              | 1008   | 0.00       |
| LSRAM                    | 1              | 352    | 0.28       |
| Math                     | 0              | 336    | 0.00       |
...
| Loop                        | Location In Source   | Trip Count | Iteration Latency | II    | Total Latency |
+-----------------------------+----------------------+------------+-------------------+-------+---------------+
| for.loop:sobel.cpp:17:5     | line 17 of sobel.cpp | 512        | 2052              | undef | 1050624       |
...
+------------------------------------------------------------------------------------------------------+
| Function: sobel_filter takes 1048582 cycles                                                          |
+-------------------------+----------------------+------------+-------------------+----+---------------+
| Loop                    | Location In Source   | Trip Count | Iteration Latency | II | Total Latency |
+-------------------------+----------------------+------------+-------------------+----+---------------+
| for.loop:sobel.cpp:20:5 | line 20 of sobel.cpp | 262144     | 6                 | 4  | 1048578       |
+-------------------------+----------------------+------------+-------------------+----+---------------+
```
...
Flattening the loop improves the cycle latency from: Simulation time (cycles): 1,050,629 to 1,048,584 (0.2% improvement).
