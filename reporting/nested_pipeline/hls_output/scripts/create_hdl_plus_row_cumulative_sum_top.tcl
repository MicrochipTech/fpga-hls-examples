...
# This Tcl file will import SmartHLS generated Verilog and create an HDL+ core for the top-level module row_cumulative_sum_top in Libero.
...
set srcFiles [concat \
    $hlsPrjAbsPath/hls_output/rtl/nested_pipeline_row_cumulative_sum.v \
...
create_hdl_core \
    -file "$hlsPrjAbsPath/hls_output/rtl/nested_pipeline_row_cumulative_sum.v" \
