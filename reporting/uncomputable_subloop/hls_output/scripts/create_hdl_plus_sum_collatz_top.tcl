...
# This Tcl file will import SmartHLS generated Verilog and create an HDL+ core for the top-level module sum_collatz_top in Libero.
...
set srcFiles [concat \
    $hlsPrjAbsPath/hls_output/rtl/uncomputable_subloop_sum_collatz.v \
...
create_hdl_core \
    -file "$hlsPrjAbsPath/hls_output/rtl/uncomputable_subloop_sum_collatz.v" \
