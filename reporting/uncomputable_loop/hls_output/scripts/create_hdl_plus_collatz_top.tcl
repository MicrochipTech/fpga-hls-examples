...
# This Tcl file will import SmartHLS generated Verilog and create an HDL+ core for the top-level module collatz_top in Libero.
...
set srcFiles [concat \
    $hlsPrjAbsPath/hls_output/rtl/uncomputable_loop_collatz.v \
...
create_hdl_core \
    -file "$hlsPrjAbsPath/hls_output/rtl/uncomputable_loop_collatz.v" \
    -module {collatz_top} \
    -library {work}
