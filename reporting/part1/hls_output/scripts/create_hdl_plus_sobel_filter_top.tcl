...
# This Tcl file will import SmartHLS generated Verilog and create an HDL+ core for the top-level module sobel_filter_top in Libero.
...
set srcFiles [concat \
    $hlsPrjAbsPath/hls_output/rtl/part1_sobel_filter.v \
...
create_hdl_core \
    -file "$hlsPrjAbsPath/hls_output/rtl/part1_sobel_filter.v" \
