; ModuleID = 'hls_output/.hls/part1.25.loop_nest_merged.bc'
...
for.cond1.preheader:                              ; preds = %for.inc57, %entry
  %i.038 = phi i32 [ 0, %entry ], [ %11, %for.inc57 ]
  %0 = add i32 %i.038, 1, !dbg !389
  %i.0.off = add i32 %i.038, -1, !dbg !392
  %scevgep4 = getelementptr [512 x i8]* %in, i32 %i.0.off, i32 -1
  %scevgep8 = getelementptr [512 x i8]* %in, i32 %i.0.off, i32 0
  %scevgep12 = getelementptr [512 x i8]* %in, i32 %i.038, i32 -511
  %scevgep16 = getelementptr [512 x i8]* %in, i32 %i.038, i32 511
  %scevgep19 = getelementptr [512 x i8]* %in, i32 %0, i32 0
  %scevgep21 = getelementptr [512 x i8]* %in, i32 %0, i32 1
  %scevgep23 = getelementptr [512 x i8]* %in, i32 %i.038, i32 -1
  %scevgep25 = getelementptr [512 x i8]* %in, i32 %i.038, i32 1
  %scevgep27 = getelementptr [512 x i8]* %out, i32 %i.038, i32 0
...
for.cond14.preheader:                             ; preds = %for.body3
  %arrayidx22 = getelementptr i8* %scevgep4, i32 %j.036, !dbg !397
  %2 = load i8* %arrayidx22, align 1, !dbg !397, !tbaa !398
  %conv23 = zext i8 %2 to i32, !dbg !397
  %arrayidx22.1 = getelementptr i8* %scevgep8, i32 %j.036, !dbg !397
  %3 = load i8* %arrayidx22.1, align 1, !dbg !397, !tbaa !398
  %conv23.1 = zext i8 %3 to i32, !dbg !397
  %add.2 = add nsw i32 %j.036, 1, !dbg !397
  %arrayidx22.2 = getelementptr i8* %scevgep12, i32 %j.036, !dbg !397
  %4 = load i8* %arrayidx22.2, align 1, !dbg !397, !tbaa !398
  %conv23.2 = zext i8 %4 to i32, !dbg !397
  %arrayidx22.139 = getelementptr i8* %scevgep23, i32 %j.036, !dbg !397
  %5 = load i8* %arrayidx22.139, align 1, !dbg !397, !tbaa !398
  %conv23.140 = zext i8 %5 to i32, !dbg !397
  %arrayidx22.2.1 = getelementptr i8* %scevgep25, i32 %j.036, !dbg !397
  %6 = load i8* %arrayidx22.2.1, align 1, !dbg !397, !tbaa !398
  %conv23.2.1 = zext i8 %6 to i32, !dbg !397
  %arrayidx22.247 = getelementptr i8* %scevgep16, i32 %j.036, !dbg !397
  %7 = load i8* %arrayidx22.247, align 1, !dbg !397, !tbaa !398
  %conv23.248 = zext i8 %7 to i32, !dbg !397
  %arrayidx22.1.2 = getelementptr i8* %scevgep19, i32 %j.036, !dbg !397
  %8 = load i8* %arrayidx22.1.2, align 1, !dbg !397, !tbaa !398
  %conv23.1.2 = zext i8 %8 to i32, !dbg !397
  %arrayidx22.2.2 = getelementptr i8* %scevgep21, i32 %j.036, !dbg !397
  %9 = load i8* %arrayidx22.2.2, align 1, !dbg !397, !tbaa !398
  %conv23.2.2 = zext i8 %9 to i32, !dbg !397
  ...
  %10 = trunc i32 %add45 to i8, !dbg !411
  %conv51 = select i1 %cmp46, i8 -1, i8 %10, !dbg !411
...
for.inc54:                                        ; preds = %if.then, %for.cond14.preheader
  ...
  %scevgep2 = getelementptr i8* %scevgep27, i32 %j.036, !dbg !416
  store i8 %conv51.sink, i8* %scevgep2, align 1, !dbg !416
  %exitcond = icmp eq i32 %inc55.pre-phi, 512, !dbg !394
  br i1 %exitcond, label %for.inc57, label %for.body3, !dbg !394

for.inc57:                                        ; preds = %for.inc54
  %11 = add nsw i32 %i.038, 1, !dbg !397
  %exitcond2 = icmp eq i32 %11, 512, !dbg !389
