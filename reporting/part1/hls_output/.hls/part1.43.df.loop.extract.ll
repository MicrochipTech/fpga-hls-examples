; ModuleID = 'hls_output/.hls/part1.43.df.loop.extract.bc'
...
for.cond1.preheader:                              ; preds = %for.inc57, %entry
  %i.038 = phi i32 [ 0, %entry ], [ %19, %for.inc57 ]
  %0 = shl i32 %i.038, 9, !dbg !390
  %1 = add i32 %0, 513, !dbg !390
  %2 = add i32 %0, 512, !dbg !390
  %3 = or i32 %0, 511, !dbg !390
  %4 = or i32 %0, 1, !dbg !390
  %5 = add i32 %0, -1, !dbg !390
  %6 = add i32 %0, -511, !dbg !390
  %7 = add i32 %0, -512, !dbg !390
  %8 = add i32 %0, -513, !dbg !390
  %i.0.off = add i32 %i.038, -1, !dbg !390
  %9 = icmp ugt i32 %i.0.off, 509, !dbg !390
  %or = zext i1 %9 to i32, !dbg !390
...
for.cond14.preheader:                             ; preds = %for.body3
  %scevgep17.sum = add i32 %8, %j.036, !dbg !395
  %mem.flat.gep7 = getelementptr [262144 x i8]* %in, i32 0, i32 %scevgep17.sum, !dbg !395
  %10 = load i8* %mem.flat.gep7, align 1, !dbg !395, !tbaa !396
  %conv23 = zext i8 %10 to i32, !dbg !395
  %scevgep15.sum = add i32 %7, %j.036, !dbg !395
  %mem.flat.gep17 = getelementptr [262144 x i8]* %in, i32 0, i32 %scevgep15.sum, !dbg !395
  %11 = load i8* %mem.flat.gep17, align 1, !dbg !395, !tbaa !396
  %conv23.1 = zext i8 %11 to i32, !dbg !395
  %scevgep13.sum = add i32 %6, %j.036, !dbg !395
  %mem.flat.gep27 = getelementptr [262144 x i8]* %in, i32 0, i32 %scevgep13.sum, !dbg !395
  %12 = load i8* %mem.flat.gep27, align 1, !dbg !395, !tbaa !396
  %conv23.2 = zext i8 %12 to i32, !dbg !395
  %scevgep11.sum = add i32 %5, %j.036, !dbg !395
  %mem.flat.gep37 = getelementptr [262144 x i8]* %in, i32 0, i32 %scevgep11.sum, !dbg !395
  %13 = load i8* %mem.flat.gep37, align 1, !dbg !395, !tbaa !396
  %conv23.140 = zext i8 %13 to i32, !dbg !395
  %scevgep9.sum = add i32 %4, %j.036, !dbg !395
  %mem.flat.gep47 = getelementptr [262144 x i8]* %in, i32 0, i32 %scevgep9.sum, !dbg !395
  %14 = load i8* %mem.flat.gep47, align 1, !dbg !395, !tbaa !396
  %conv23.2.1 = zext i8 %14 to i32, !dbg !395
  %scevgep7.sum = add i32 %3, %j.036, !dbg !395
  %mem.flat.gep57 = getelementptr [262144 x i8]* %in, i32 0, i32 %scevgep7.sum, !dbg !395
  %15 = load i8* %mem.flat.gep57, align 1, !dbg !395, !tbaa !396
  %conv23.248 = zext i8 %15 to i32, !dbg !395
  %scevgep5.sum = add i32 %2, %j.036, !dbg !395
  %mem.flat.gep67 = getelementptr [262144 x i8]* %in, i32 0, i32 %scevgep5.sum, !dbg !395
  %16 = load i8* %mem.flat.gep67, align 1, !dbg !395, !tbaa !396
  %conv23.1.2 = zext i8 %16 to i32, !dbg !395
  %scevgep3.sum = add i32 %1, %j.036, !dbg !395
  %mem.flat.gep77 = getelementptr [262144 x i8]* %in, i32 0, i32 %scevgep3.sum, !dbg !395
  %17 = load i8* %mem.flat.gep77, align 1, !dbg !395, !tbaa !396
  %conv23.2.2 = zext i8 %17 to i32, !dbg !395
  %tmp = sub i32 %conv23.2.1, %conv23.140
  %tmp1 = shl nsw i32 %tmp, 1
  %add28.143 = sub i32 %conv23.2, %conv23, !dbg !399
  %add28.2.1 = sub i32 %add28.143, %conv23.248, !dbg !399
  %add28.251 = add nsw i32 %add28.2.1, %conv23.2.2, !dbg !399
  %add28.2.2 = add nsw i32 %add28.251, %tmp1, !dbg !399
  %tmp3 = sub i32 %conv23.1, %conv23.1.2
  %tmp4 = shl nsw i32 %tmp3, 1
  %add34.2 = add nuw nsw i32 %conv23.2, %conv23, !dbg !400
  %add34.254 = sub i32 %add34.2, %conv23.248, !dbg !400
  %add34.1.2 = sub i32 %add34.254, %conv23.2.2, !dbg !400
  %add34.2.2 = add nsw i32 %add34.1.2, %tmp4, !dbg !400
  %cmp38 = icmp slt i32 %add28.2.2, 0, !dbg !401
  %sub = sub nsw i32 0, %add28.2.2, !dbg !402
  %cond = select i1 %cmp38, i32 %sub, i32 %add28.2.2, !dbg !401
  %cmp39 = icmp slt i32 %add34.2.2, 0, !dbg !404
  %sub41 = sub nsw i32 0, %add34.2.2, !dbg !405
  %cond44 = select i1 %cmp39, i32 %sub41, i32 %add34.2.2, !dbg !404
  %add45 = add nsw i32 %cond44, %cond, !dbg !407
  %cmp46 = icmp sgt i32 %add45, 255, !dbg !408
  %18 = trunc i32 %add45 to i8, !dbg !409
  %conv51 = select i1 %cmp46, i8 -1, i8 %18, !dbg !409
  br label %for.inc54, !dbg !410
...
for.inc54:                                        ; preds = %for.cond14.preheader, %for.body3.for.inc54_crit_edge
  ...
  %inc55.pre-phi.pre-phi = add i32 %j.036, 1, !dbg !411
  %scevgep.sum = add i32 %0, %j.036, !dbg !412
  %mem.flat.gep87 = getelementptr [262144 x i8]* %out, i32 0, i32 %scevgep.sum, !dbg !412
...
for.inc57:                                        ; preds = %for.inc54
  %19 = add i32 %i.038, 1, !dbg !387
  %exitcond1 = icmp eq i32 %19, 512, !dbg !387
  br i1 %exitcond1, label %for.end59, label %for.cond1.preheader, !dbg !387, !legup.tripCount !415
...
!395 = metadata !{i32 29, i32 21, metadata !31, null}
!396 = metadata !{metadata !397, metadata !397, i64 0}
!397 = metadata !{metadata !"omnipotent char", metadata !398, i64 0}
!398 = metadata !{metadata !"Simple C/C++ TBAA"}
!399 = metadata !{i32 30, i32 21, metadata !31, null}
!400 = metadata !{i32 31, i32 21, metadata !31, null}
!401 = metadata !{i32 35, i32 13, metadata !23, null}
!402 = metadata !{i32 35, i32 13, metadata !403, null}
!403 = metadata !{i32 786443, metadata !1, metadata !23, i32 35, i32 13, i32 1, i32 20} ; [ DW_TAG_lexical_block ] [/home/parisa/fpga-hls-examples/sobel_tutorial/part1/sobel.cpp]
!404 = metadata !{i32 36, i32 13, metadata !23, null}
!405 = metadata !{i32 36, i32 13, metadata !406, null}
!406 = metadata !{i32 786443, metadata !1, metadata !23, i32 36, i32 13, i32 1, i32 24} ; [ DW_TAG_lexical_block ] [/home/parisa/fpga-hls-examples/sobel_tutorial/part1/sobel.cpp]
!407 = metadata !{i32 38, i32 13, metadata !23, null}
!408 = metadata !{i32 39, i32 13, metadata !23, null}
!409 = metadata !{i32 41, i32 13, metadata !23, null}
!410 = metadata !{i32 42, i32 9, metadata !23, null}
!411 = metadata !{i32 18, i32 36, metadata !20, null}
