; ModuleID = 'hls_output/.hls/part1.53.ifconv.2.bc'
...
for.cond1.preheader:                              ; preds = %for.inc57, %entry
  %i.038 = phi i32 [ 0, %entry ], [ %30, %for.inc57 ]
  %0 = shl i32 %i.038, 9, !dbg !390
  %1 = add i32 %0, -513, !dbg !390
  %2 = add i32 %0, -512, !dbg !390
  %3 = add i32 %0, -511, !dbg !390
  %4 = add i32 %0, -1, !dbg !390
  %5 = or i32 %0, 1, !dbg !390
  %6 = or i32 %0, 511, !dbg !390
...
for.body3:                                        ; preds = %for.inc54, %for.cond1.preheader
  %10 = phi i32 [ 0, %for.cond1.preheader ], [ %28, %for.inc54 ], !dbg !390
  %loop.init.phi = phi i32 [ %0, %for.cond1.preheader ], [ %29, %for.inc54 ]
  %mem.flat.gep87 = getelementptr [262144 x i8]* %out, i32 0, i32 %loop.init.phi, !dbg !395
  %cmp7 = icmp slt i32 %10, 1, !dbg !390
  %conv8 = zext i1 %cmp7 to i32, !dbg !390
  %or9 = or i32 %conv8, %or, !dbg !390
  %cmp10 = icmp sgt i32 %10, 510, !dbg !390
  %conv11 = zext i1 %cmp10 to i32, !dbg !390
  %or12 = or i32 %or9, %conv11, !dbg !390
  %tobool = icmp eq i32 %or12, 0, !dbg !390
  %11 = add i32 %8, %10, !dbg !390
  %12 = add i32 %7, %10, !dbg !390
  %13 = add i32 %6, %10, !dbg !390
  %14 = add i32 %5, %10, !dbg !390
  %15 = add i32 %4, %10, !dbg !390
  %16 = add i32 %3, %10, !dbg !390
  %17 = add i32 %2, %10, !dbg !390
  %18 = add i32 %1, %10, !dbg !390
  br i1 %tobool, label %for.cond14.preheader, label %for.inc54, !dbg !390

for.cond14.preheader:                             ; preds = %for.body3
  %mem.flat.gep77 = getelementptr [262144 x i8]* %in, i32 0, i32 %11, !dbg !397
  %mem.flat.gep67 = getelementptr [262144 x i8]* %in, i32 0, i32 %12, !dbg !397
  %mem.flat.gep57 = getelementptr [262144 x i8]* %in, i32 0, i32 %13, !dbg !397
  %mem.flat.gep47 = getelementptr [262144 x i8]* %in, i32 0, i32 %14, !dbg !397
  %mem.flat.gep37 = getelementptr [262144 x i8]* %in, i32 0, i32 %15, !dbg !397
  %mem.flat.gep27 = getelementptr [262144 x i8]* %in, i32 0, i32 %16, !dbg !397
  %mem.flat.gep17 = getelementptr [262144 x i8]* %in, i32 0, i32 %17, !dbg !397
  %mem.flat.gep7 = getelementptr [262144 x i8]* %in, i32 0, i32 %18, !dbg !397
  %19 = load i8* %mem.flat.gep7, align 1, !dbg !397, !tbaa !398
  %conv23 = zext i8 %19 to i32, !dbg !397
  %20 = load i8* %mem.flat.gep17, align 1, !dbg !397, !tbaa !398
  %conv23.1 = zext i8 %20 to i32, !dbg !397
  %21 = load i8* %mem.flat.gep27, align 1, !dbg !397, !tbaa !398
  %conv23.2 = zext i8 %21 to i32, !dbg !397
  %22 = load i8* %mem.flat.gep37, align 1, !dbg !397, !tbaa !398
  %conv23.140 = zext i8 %22 to i32, !dbg !397
  %23 = load i8* %mem.flat.gep47, align 1, !dbg !397, !tbaa !398
  %conv23.2.1 = zext i8 %23 to i32, !dbg !397
  %24 = load i8* %mem.flat.gep57, align 1, !dbg !397, !tbaa !398
  %conv23.248 = zext i8 %24 to i32, !dbg !397
  %25 = load i8* %mem.flat.gep67, align 1, !dbg !397, !tbaa !398
  %conv23.1.2 = zext i8 %25 to i32, !dbg !397
  %26 = load i8* %mem.flat.gep77, align 1, !dbg !397, !tbaa !398
  %conv23.2.2 = zext i8 %26 to i32, !dbg !397
  ...
  %27 = trunc i32 %add45 to i8, !dbg !411
  %conv51 = select i1 %cmp46, i8 -1, i8 %27, !dbg !411
