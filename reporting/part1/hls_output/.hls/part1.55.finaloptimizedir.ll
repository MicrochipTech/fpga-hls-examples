; ModuleID = 'hls_output/.hls/part1.55.finaloptimizedir.bc'
...
for.cond1.preheader:                              ; preds = %for.inc57, %entry
  %i.038 = phi i32 [ 0, %entry ], [ %26, %for.inc57 ]
  %bit_select17 = call i23 @hls_bit_select_23_32(i32 %i.038, i64 22, i64 0)
  %bit_concat20 = call i32 @hls_bit_concat_23_9(i23 %bit_select17, i64 23, i9 0, i64 9)
  %0 = add i32 %bit_concat20, -513, !dbg !390
  %1 = add i32 %bit_concat20, -512, !dbg !390
  %2 = add i32 %bit_concat20, -511, !dbg !390
  %3 = add i32 %bit_concat20, -1, !dbg !390
  %bit_concat19 = call i32 @hls_bit_concat_23_9(i23 %bit_select17, i64 23, i9 1, i64 9)
  %bit_concat18 = call i32 @hls_bit_concat_23_9(i23 %bit_select17, i64 23, i9 -1, i64 9)
  %4 = add i32 %bit_concat20, 512, !dbg !390
  %5 = add i32 %bit_concat20, 513, !dbg !390
  %i.0.off = add i32 %i.038, -1, !dbg !390
  %6 = icmp ugt i32 %i.0.off, 509, !dbg !390
  %bit_concat16 = call i32 @hls_bit_concat_31_1(i31 0, i64 31, i1 %6, i64 1)
  br label %for.body3, !dbg !392

for.body3:                                        ; preds = %for.inc54, %for.cond1.preheader
  %7 = phi i32 [ 0, %for.cond1.preheader ], [ %24, %for.inc54 ], !dbg !390
  %loop.init.phi = phi i32 [ %bit_concat20, %for.cond1.preheader ], [ %25, %for.inc54 ]
  %mem.flat.gep87 = getelementptr [262144 x i8]* %out, i32 0, i32 %loop.init.phi, !dbg !395
  %cmp7 = icmp slt i32 %7, 1, !dbg !390
  %bit_concat15 = call i32 @hls_bit_concat_31_1(i31 0, i64 31, i1 %cmp7, i64 1)
  %or9 = or i32 %bit_concat15, %bit_concat16, !dbg !390
  %cmp10 = icmp sgt i32 %7, 510, !dbg !390
  %bit_concat14 = call i32 @hls_bit_concat_31_1(i31 0, i64 31, i1 %cmp10, i64 1)
  %or12 = or i32 %or9, %bit_concat14, !dbg !390
  %tobool = icmp eq i32 %or12, 0, !dbg !390
  %8 = add i32 %5, %7, !dbg !390
  %9 = add i32 %4, %7, !dbg !390
  %10 = add i32 %bit_concat18, %7, !dbg !390
  %11 = add i32 %bit_concat19, %7, !dbg !390
  %12 = add i32 %3, %7, !dbg !390
  %13 = add i32 %2, %7, !dbg !390
  %14 = add i32 %1, %7, !dbg !390
  %15 = add i32 %0, %7, !dbg !390
  br i1 %tobool, label %for.cond14.preheader, label %for.inc54, !dbg !390

for.cond14.preheader:                             ; preds = %for.body3
  %mem.flat.gep77 = getelementptr [262144 x i8]* %in, i32 0, i32 %8, !dbg !397
  %mem.flat.gep67 = getelementptr [262144 x i8]* %in, i32 0, i32 %9, !dbg !397
  %mem.flat.gep57 = getelementptr [262144 x i8]* %in, i32 0, i32 %10, !dbg !397
  %mem.flat.gep47 = getelementptr [262144 x i8]* %in, i32 0, i32 %11, !dbg !397
  %mem.flat.gep37 = getelementptr [262144 x i8]* %in, i32 0, i32 %12, !dbg !397
  %mem.flat.gep27 = getelementptr [262144 x i8]* %in, i32 0, i32 %13, !dbg !397
  %mem.flat.gep17 = getelementptr [262144 x i8]* %in, i32 0, i32 %14, !dbg !397
  %mem.flat.gep7 = getelementptr [262144 x i8]* %in, i32 0, i32 %15, !dbg !397
  %16 = load i8* %mem.flat.gep7, align 1, !dbg !397, !tbaa !398
  %bit_concat13 = call i32 @hls_bit_concat_24_8(i24 0, i64 24, i8 %16, i64 8)
  %17 = load i8* %mem.flat.gep17, align 1, !dbg !397, !tbaa !398
  %bit_concat12 = call i32 @hls_bit_concat_24_8(i24 0, i64 24, i8 %17, i64 8)
  %18 = load i8* %mem.flat.gep27, align 1, !dbg !397, !tbaa !398
  %bit_concat11 = call i32 @hls_bit_concat_24_8(i24 0, i64 24, i8 %18, i64 8)
  %19 = load i8* %mem.flat.gep37, align 1, !dbg !397, !tbaa !398
  %bit_concat10 = call i32 @hls_bit_concat_24_8(i24 0, i64 24, i8 %19, i64 8)
  %20 = load i8* %mem.flat.gep47, align 1, !dbg !397, !tbaa !398
  %bit_concat9 = call i32 @hls_bit_concat_24_8(i24 0, i64 24, i8 %20, i64 8)
  %21 = load i8* %mem.flat.gep57, align 1, !dbg !397, !tbaa !398
  %bit_concat8 = call i32 @hls_bit_concat_24_8(i24 0, i64 24, i8 %21, i64 8)
  %22 = load i8* %mem.flat.gep67, align 1, !dbg !397, !tbaa !398
  %bit_concat7 = call i32 @hls_bit_concat_24_8(i24 0, i64 24, i8 %22, i64 8)
  %23 = load i8* %mem.flat.gep77, align 1, !dbg !397, !tbaa !398
  %bit_concat6 = call i32 @hls_bit_concat_24_8(i24 0, i64 24, i8 %23, i64 8)
  %tmp = sub i32 %bit_concat9, %bit_concat10
  %bit_select4 = call i31 @hls_bit_select_31_32(i32 %tmp, i64 30, i64 0)
  %bit_concat5 = call i32 @hls_bit_concat_31_1(i31 %bit_select4, i64 31, i1 false, i64 1)
  %add28.143 = sub i32 %bit_concat11, %bit_concat13, !dbg !401
  %add28.2.1 = sub i32 %add28.143, %bit_concat8, !dbg !401
  %add28.251 = add nsw i32 %add28.2.1, %bit_concat6, !dbg !401
  %add28.2.2 = add nsw i32 %add28.251, %bit_concat5, !dbg !401
  %bit_select2 = call i1 @hls_bit_select_1_32(i32 %add28.2.2, i64 31, i64 31)
  %tmp3 = sub i32 %bit_concat12, %bit_concat7
  %bit_select3 = call i31 @hls_bit_select_31_32(i32 %tmp3, i64 30, i64 0)
  %bit_concat = call i32 @hls_bit_concat_31_1(i31 %bit_select3, i64 31, i1 false, i64 1)
  %add34.2 = add nuw nsw i32 %bit_concat11, %bit_concat13, !dbg !402
  %add34.254 = sub i32 %add34.2, %bit_concat8, !dbg !402
  %add34.1.2 = sub i32 %add34.254, %bit_concat6, !dbg !402
  %add34.2.2 = add nsw i32 %add34.1.2, %bit_concat, !dbg !402
  %bit_select1 = call i1 @hls_bit_select_1_32(i32 %add34.2.2, i64 31, i64 31)
  %sub = sub nsw i32 0, %add28.2.2, !dbg !403
  %cond = select i1 %bit_select2, i32 %sub, i32 %add28.2.2, !dbg !405
  %sub41 = sub nsw i32 0, %add34.2.2, !dbg !406
  %cond44 = select i1 %bit_select1, i32 %sub41, i32 %add34.2.2, !dbg !408
  %add45 = add nsw i32 %cond44, %cond, !dbg !409
  %bit_select = call i8 @hls_bit_select_8_32(i32 %add45, i64 7, i64 0)
  %cmp46 = icmp sgt i32 %add45, 255, !dbg !410
  %conv51 = select i1 %cmp46, i8 -1, i8 %bit_select, !dbg !411
  br label %for.inc54, !dbg !412

for.inc54:                                        ; preds = %for.cond14.preheader, %for.body3
  %conv51.sink = phi i8 [ %conv51, %for.cond14.preheader ], [ 0, %for.body3 ]
  %24 = add i32 %7, 1, !dbg !413
  store i8 %conv51.sink, i8* %mem.flat.gep87, align 1, !dbg !395
  %exitcond2 = icmp eq i32 %24, 512, !dbg !392
  %25 = add i32 %bit_concat20, %24, !dbg !390
  br i1 %exitcond2, label %for.inc57, label %for.body3, !dbg !392, !legup.tripCount !414

for.inc57:                                        ; preds = %for.inc54
  %26 = add i32 %i.038, 1, !dbg !387
  %exitcond = icmp eq i32 %26, 512, !dbg !387
  br i1 %exitcond, label %for.end59, label %for.cond1.preheader, !dbg !387, !legup.tripCount !415
...
!395 = metadata !{i32 21, i32 17, metadata !396, null}
!396 = metadata !{i32 786443, metadata !1, metadata !391, i32 20, i32 73, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/parisa/fpga-hls-examples/sobel_tutorial/part1/sobel.cpp]
!397 = metadata !{i32 29, i32 21, metadata !31, null}
...
!405 = metadata !{i32 35, i32 13, metadata !23, null}
...
!408 = metadata !{i32 36, i32 13, metadata !23, null}
