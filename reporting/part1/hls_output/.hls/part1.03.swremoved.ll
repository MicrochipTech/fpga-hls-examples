; ModuleID = 'hls_output/.hls/part1.03.swremoved.bc'
...
for.cond14.preheader:                             ; preds = %for.body3
  ...
  %mul33.1 = shl nuw nsw i32 %conv23.1, 1, !dbg !80
  %add34.1 = add nuw nsw i32 %mul33.1, %conv23, !dbg !80
  ...
  %add28.2 = sub i32 %conv23.2, %conv23, !dbg !81
  %add34.2 = add nuw nsw i32 %conv23.2, %add34.1, !dbg !80
  ...
  %mul.142 = mul nsw i32 %conv23.140, -2, !dbg !81
  %add28.143 = add nsw i32 %mul.142, %add28.2, !dbg !81
  ...
  %mul.2.1 = shl nuw nsw i32 %conv23.2.1, 1, !dbg !81
  %add28.2.1 = add nsw i32 %mul.2.1, %add28.143, !dbg !81
  ...
  %add28.251 = sub i32 %add28.2.1, %conv23.248, !dbg !81
  %add34.254 = sub i32 %add34.2, %conv23.248, !dbg !80
  ...
  %mul33.1.2 = mul nsw i32 %conv23.1.2, -2, !dbg !80
  %add34.1.2 = add nsw i32 %mul33.1.2, %add34.254, !dbg !80
  ...
  %add28.2.2 = add nsw i32 %conv23.2.2, %add28.251, !dbg !81
  %add34.2.2 = sub i32 %add34.1.2, %conv23.2.2, !dbg !80
...
for.inc54:                                        ; preds = %if.then, %for.cond14.preheader
  ...
  %inc55.pre-phi = phi i32 [ %add.2, %for.cond14.preheader ], [ %inc55.pre, %if.then ], !dbg !92
...
!80 = metadata !{i32 31, i32 21, metadata !31, null}
!81 = metadata !{i32 30, i32 21, metadata !31, null}
