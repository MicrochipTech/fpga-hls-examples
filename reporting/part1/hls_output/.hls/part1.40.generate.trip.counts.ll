; ModuleID = 'hls_output/.hls/part1.40.generate.trip.counts.bc'
target datalayout = "e-m:e-p:32:32-f64:32:64-f80:32-n8:16:32-S128"
target triple = "i386-unknown-linux-gnu"

; Function Attrs: noinline nounwind
declare void @0([512 x i8]* noalias nocapture readonly "legup_array_depth"="262144" "legup_decl"="unsigned char in[512][512]", [512 x i8]* noalias nocapture "legup_array_depth"="262144" "legup_decl"="unsigned char out[512][512]") #0
...
entry:
  br label %for.cond1.preheader, !dbg !387

for.cond1.preheader:                              ; preds = %for.inc57, %entry
  %i.038 = phi i32 [ 0, %entry ], [ %0, %for.inc57 ]
  %0 = add i32 %i.038, 1, !dbg !387
  %i.0.off = add i32 %i.038, -1, !dbg !390
  %1 = icmp ugt i32 %i.0.off, 509, !dbg !390
  %or = zext i1 %1 to i32, !dbg !390
  %mem.flat.add = shl i32 %i.038, 9
  %mem.flat.mul = add i32 %mem.flat.add, -512
  %mem.flat.add3 = shl i32 %i.038, 9
  %mem.flat.mul4 = add i32 %mem.flat.add3, -512
  %mem.flat.mul10 = shl i32 %i.038, 9
  %mem.flat.mul16 = shl i32 %i.038, 9
  %mem.flat.mul22 = shl i32 %i.038, 9
  %mem.flat.mul28 = shl i32 %i.038, 9
  %mem.flat.add33 = shl i32 %i.038, 9
  %mem.flat.mul34 = add i32 %mem.flat.add33, 512
  %mem.flat.add39 = shl i32 %i.038, 9
  %mem.flat.mul40 = add i32 %mem.flat.add39, 512
  %mem.flat.mul46 = shl i32 %i.038, 9
  br label %for.body3, !dbg !392

for.body3:                                        ; preds = %for.inc54, %for.cond1.preheader
  %j.036 = phi i32 [ 0, %for.cond1.preheader ], [ %inc55.pre-phi.pre-phi, %for.inc54 ]
  %cmp7 = icmp slt i32 %j.036, 1, !dbg !390
  %conv8 = zext i1 %cmp7 to i32, !dbg !390
  %or9 = or i32 %conv8, %or, !dbg !390
  %cmp10 = icmp sgt i32 %j.036, 510, !dbg !390
  %conv11 = zext i1 %cmp10 to i32, !dbg !390
  %or12 = or i32 %or9, %conv11, !dbg !390
  %tobool = icmp eq i32 %or12, 0, !dbg !390
  br i1 %tobool, label %for.cond14.preheader, label %for.body3.for.inc54_crit_edge, !dbg !390

for.body3.for.inc54_crit_edge:                    ; preds = %for.body3
  %inc55.pre-phi.pre = add nsw i32 %j.036, 1, !dbg !395
  br label %for.inc54, !dbg !390

for.cond14.preheader:                             ; preds = %for.body3
  %scevgep4.sum = add i32 %j.036, -1, !dbg !396
  %mem.flat.add4 = add i32 %mem.flat.mul, %scevgep4.sum
  %mem.flat.gep7 = getelementptr [262144 x i8]* %in, i32 0, i32 %mem.flat.add4
  %2 = load i8* %mem.flat.gep7, align 1, !dbg !396, !tbaa !397
  %conv23 = zext i8 %2 to i32, !dbg !396
  %mem.flat.add14 = add i32 %mem.flat.mul4, %j.036
  %mem.flat.gep17 = getelementptr [262144 x i8]* %in, i32 0, i32 %mem.flat.add14
  %3 = load i8* %mem.flat.gep17, align 1, !dbg !396, !tbaa !397
  %conv23.1 = zext i8 %3 to i32, !dbg !396
  %scevgep12.sum = add i32 %j.036, -511, !dbg !396
  %mem.flat.add24 = add i32 %mem.flat.mul10, %scevgep12.sum
  %mem.flat.gep27 = getelementptr [262144 x i8]* %in, i32 0, i32 %mem.flat.add24
  %4 = load i8* %mem.flat.gep27, align 1, !dbg !396, !tbaa !397
  %conv23.2 = zext i8 %4 to i32, !dbg !396
  %mem.flat.add34 = add i32 %mem.flat.mul16, %scevgep4.sum
  %mem.flat.gep37 = getelementptr [262144 x i8]* %in, i32 0, i32 %mem.flat.add34
  %5 = load i8* %mem.flat.gep37, align 1, !dbg !396, !tbaa !397
  %conv23.140 = zext i8 %5 to i32, !dbg !396
  %scevgep25.sum = add i32 %j.036, 1, !dbg !396
  %mem.flat.add44 = add i32 %mem.flat.mul22, %scevgep25.sum
  %mem.flat.gep47 = getelementptr [262144 x i8]* %in, i32 0, i32 %mem.flat.add44
  %6 = load i8* %mem.flat.gep47, align 1, !dbg !396, !tbaa !397
  %conv23.2.1 = zext i8 %6 to i32, !dbg !396
  %scevgep16.sum = add i32 %j.036, 511, !dbg !396
  %mem.flat.add54 = add i32 %mem.flat.mul28, %scevgep16.sum
  %mem.flat.gep57 = getelementptr [262144 x i8]* %in, i32 0, i32 %mem.flat.add54
  %7 = load i8* %mem.flat.gep57, align 1, !dbg !396, !tbaa !397
  %conv23.248 = zext i8 %7 to i32, !dbg !396
  %mem.flat.add64 = add i32 %mem.flat.mul34, %j.036
  %mem.flat.gep67 = getelementptr [262144 x i8]* %in, i32 0, i32 %mem.flat.add64
  %8 = load i8* %mem.flat.gep67, align 1, !dbg !396, !tbaa !397
  %conv23.1.2 = zext i8 %8 to i32, !dbg !396
  %mem.flat.add74 = add i32 %mem.flat.mul40, %scevgep25.sum
  %mem.flat.gep77 = getelementptr [262144 x i8]* %in, i32 0, i32 %mem.flat.add74
  %9 = load i8* %mem.flat.gep77, align 1, !dbg !396, !tbaa !397
  %conv23.2.2 = zext i8 %9 to i32, !dbg !396
  %tmp = sub i32 %conv23.2.1, %conv23.140
  %tmp1 = shl nsw i32 %tmp, 1
  %add28.143 = sub i32 %conv23.2, %conv23, !dbg !400
  %add28.2.1 = sub i32 %add28.143, %conv23.248, !dbg !400
  %add28.251 = add nsw i32 %add28.2.1, %conv23.2.2, !dbg !400
  %add28.2.2 = add nsw i32 %add28.251, %tmp1, !dbg !400
  %tmp3 = sub i32 %conv23.1, %conv23.1.2
  %tmp4 = shl nsw i32 %tmp3, 1
  %add34.2 = add nuw nsw i32 %conv23.2, %conv23, !dbg !401
  %add34.254 = sub i32 %add34.2, %conv23.248, !dbg !401
  %add34.1.2 = sub i32 %add34.254, %conv23.2.2, !dbg !401
  %add34.2.2 = add nsw i32 %add34.1.2, %tmp4, !dbg !401
  %cmp38 = icmp slt i32 %add28.2.2, 0, !dbg !402
  %sub = sub nsw i32 0, %add28.2.2, !dbg !403
  %cond = select i1 %cmp38, i32 %sub, i32 %add28.2.2, !dbg !402
  %cmp39 = icmp slt i32 %add34.2.2, 0, !dbg !405
  %sub41 = sub nsw i32 0, %add34.2.2, !dbg !406
  %cond44 = select i1 %cmp39, i32 %sub41, i32 %add34.2.2, !dbg !405
  %add45 = add nsw i32 %cond44, %cond, !dbg !408
  %cmp46 = icmp sgt i32 %add45, 255, !dbg !409
  %10 = trunc i32 %add45 to i8, !dbg !410
  %conv51 = select i1 %cmp46, i8 -1, i8 %10, !dbg !410
  br label %for.inc54, !dbg !411

for.inc54:                                        ; preds = %for.cond14.preheader, %for.body3.for.inc54_crit_edge
  %inc55.pre-phi.pre-phi = phi i32 [ %inc55.pre-phi.pre, %for.body3.for.inc54_crit_edge ], [ %scevgep25.sum, %for.cond14.preheader ], !dbg !395
  %conv51.sink = phi i8 [ 0, %for.body3.for.inc54_crit_edge ], [ %conv51, %for.cond14.preheader ]
  %mem.flat.add84 = add i32 %mem.flat.mul46, %j.036
  %mem.flat.gep87 = getelementptr [262144 x i8]* %out, i32 0, i32 %mem.flat.add84
  store i8 %conv51.sink, i8* %mem.flat.gep87, align 1, !dbg !412
  %exitcond = icmp eq i32 %inc55.pre-phi.pre-phi, 512, !dbg !392
  br i1 %exitcond, label %for.inc57, label %for.body3, !dbg !392, !legup.tripCount !414

for.inc57:                                        ; preds = %for.inc54
  %exitcond2 = icmp eq i32 %0, 512, !dbg !387
  br i1 %exitcond2, label %for.end59, label %for.cond1.preheader, !dbg !387, !legup.tripCount !415
...
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"sobel_filter", metadata !"sobel_filter", metadata !"_Z12sobel_filterPA512_hS0_", i32 9, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, void ([512 x i8]*, [512 x i8]*)* @0, null, null, metadata !13, i32 10} ; [ DW_TAG_subprogram ] [line 9] [def] [scope 10] [sobel_filter]
...
!390 = metadata !{i32 20, i32 17, metadata !391, null}
!391 = metadata !{i32 786443, metadata !1, metadata !23, i32 20, i32 17, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/parisa/fpga-hls-examples/sobel_tutorial/part1/sobel.cpp]
!392 = metadata !{i32 18, i32 14, metadata !393, null}
!393 = metadata !{i32 786443, metadata !1, metadata !394, i32 18, i32 14, i32 2, i32 32} ; [ DW_TAG_lexical_block ] [/home/parisa/fpga-hls-examples/sobel_tutorial/part1/sobel.cpp]
!394 = metadata !{i32 786443, metadata !1, metadata !20, i32 18, i32 14, i32 1, i32 15} ; [ DW_TAG_lexical_block ] [/home/parisa/fpga-hls-examples/sobel_tutorial/part1/sobel.cpp]
!395 = metadata !{i32 18, i32 36, metadata !20, null}
!396 = metadata !{i32 29, i32 21, metadata !31, null}
!397 = metadata !{metadata !398, metadata !398, i64 0}
!398 = metadata !{metadata !"omnipotent char", metadata !399, i64 0}
!399 = metadata !{metadata !"Simple C/C++ TBAA"}
!400 = metadata !{i32 30, i32 21, metadata !31, null}
!401 = metadata !{i32 31, i32 21, metadata !31, null}
!402 = metadata !{i32 35, i32 13, metadata !23, null}
!403 = metadata !{i32 35, i32 13, metadata !404, null}
!404 = metadata !{i32 786443, metadata !1, metadata !23, i32 35, i32 13, i32 1, i32 20} ; [ DW_TAG_lexical_block ] [/home/parisa/fpga-hls-examples/sobel_tutorial/part1/sobel.cpp]
!405 = metadata !{i32 36, i32 13, metadata !23, null}
!406 = metadata !{i32 36, i32 13, metadata !407, null}
!407 = metadata !{i32 786443, metadata !1, metadata !23, i32 36, i32 13, i32 1, i32 24} ; [ DW_TAG_lexical_block ] [/home/parisa/fpga-hls-examples/sobel_tutorial/part1/sobel.cpp]
!408 = metadata !{i32 38, i32 13, metadata !23, null}
!409 = metadata !{i32 39, i32 13, metadata !23, null}
!410 = metadata !{i32 41, i32 13, metadata !23, null}
!411 = metadata !{i32 42, i32 9, metadata !23, null}
!412 = metadata !{i32 21, i32 17, metadata !413, null}
!413 = metadata !{i32 786443, metadata !1, metadata !391, i32 20, i32 73, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/parisa/fpga-hls-examples/sobel_tutorial/part1/sobel.cpp]
!414 = metadata !{metadata !"0"}
!415 = metadata !{metadata !"512"}
