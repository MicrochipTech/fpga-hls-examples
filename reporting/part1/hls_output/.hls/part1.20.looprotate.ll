; ModuleID = 'hls_output/.hls/part1.20.looprotate.bc'
...
for.cond1.preheader:                              ; preds = %for.inc57, %entry
  %i.038 = phi i32 [ 0, %entry ], [ %1, %for.inc57 ]
  %scevgep = getelementptr [512 x i8]* %out, i32 %i.038, i32 0
  %scevgep3 = getelementptr [512 x i8]* %in, i32 %i.038, i32 1
  %scevgep5 = getelementptr [512 x i8]* %in, i32 %i.038, i32 -1
  %add20.2 = add i32 %i.038, 1, !dbg !389
  %scevgep7 = getelementptr [512 x i8]* %in, i32 %add20.2, i32 1
  %scevgep9 = getelementptr [512 x i8]* %in, i32 %add20.2, i32 0
  %scevgep11 = getelementptr [512 x i8]* %in, i32 %i.038, i32 511
  %scevgep13 = getelementptr [512 x i8]* %in, i32 %i.038, i32 -511
  %i.0.off = add i32 %i.038, -1, !dbg !392
  %scevgep15 = getelementptr [512 x i8]* %in, i32 %i.0.off, i32 0
  %scevgep17 = getelementptr [512 x i8]* %in, i32 %i.0.off, i32 -1
  %0 = icmp ugt i32 %i.0.off, 509, !dbg !392
  %or = zext i1 %0 to i32, !dbg !392
  %1 = add nsw i32 %i.038, 1, !dbg !394
...
for.cond14.preheader:                             ; preds = %for.body3
  %arrayidx22 = getelementptr i8* %scevgep17, i32 %j.036, !dbg !394
  %2 = load i8* %arrayidx22, align 1, !dbg !394, !tbaa !398
  %conv23 = zext i8 %2 to i32, !dbg !394
  %arrayidx22.1 = getelementptr i8* %scevgep15, i32 %j.036, !dbg !394
  %3 = load i8* %arrayidx22.1, align 1, !dbg !394, !tbaa !398
  %conv23.1 = zext i8 %3 to i32, !dbg !394
  %add.2 = add nsw i32 %j.036, 1, !dbg !394
  %arrayidx22.2 = getelementptr i8* %scevgep13, i32 %j.036, !dbg !394
  %4 = load i8* %arrayidx22.2, align 1, !dbg !394, !tbaa !398
  %conv23.2 = zext i8 %4 to i32, !dbg !394
  %arrayidx22.139 = getelementptr i8* %scevgep5, i32 %j.036, !dbg !394
  %5 = load i8* %arrayidx22.139, align 1, !dbg !394, !tbaa !398
  %conv23.140 = zext i8 %5 to i32, !dbg !394
  %arrayidx22.2.1 = getelementptr i8* %scevgep3, i32 %j.036, !dbg !394
  %6 = load i8* %arrayidx22.2.1, align 1, !dbg !394, !tbaa !398
  %conv23.2.1 = zext i8 %6 to i32, !dbg !394
  %arrayidx22.247 = getelementptr i8* %scevgep11, i32 %j.036, !dbg !394
  %7 = load i8* %arrayidx22.247, align 1, !dbg !394, !tbaa !398
  %conv23.248 = zext i8 %7 to i32, !dbg !394
  %arrayidx22.1.2 = getelementptr i8* %scevgep9, i32 %j.036, !dbg !394
  %8 = load i8* %arrayidx22.1.2, align 1, !dbg !394, !tbaa !398
  %conv23.1.2 = zext i8 %8 to i32, !dbg !394
  %arrayidx22.2.2 = getelementptr i8* %scevgep7, i32 %j.036, !dbg !394
  %9 = load i8* %arrayidx22.2.2, align 1, !dbg !394, !tbaa !398
  %conv23.2.2 = zext i8 %9 to i32, !dbg !394
...
for.inc54:                                        ; preds = %if.then, %for.cond14.preheader
  ...
  %scevgep2 = getelementptr i8* %scevgep, i32 %j.036, !dbg !416
...
for.inc57:                                        ; preds = %for.inc54
  %exitcond1 = icmp eq i32 %1, 512, !dbg !389
  br i1 %exitcond1, label %for.end59, label %for.cond1.preheader, !dbg !389
