; ModuleID = 'hls_output/.hls/part1.54.finaloptimizedir.bc'
...
for.inc54:                                        ; preds = %for.cond14.preheader, %for.body3
  ...
  br i1 %exitcond2, label %for.inc57, label %for.body3, !dbg !392

for.inc57:                                        ; preds = %for.inc54
  %26 = add i32 %i.038, 1, !dbg !387
  %exitcond = icmp eq i32 %26, 512, !dbg !387
  br i1 %exitcond, label %for.end59, label %for.cond1.preheader, !dbg !387
