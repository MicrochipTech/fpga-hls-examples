; ModuleID = 'hls_output/.hls/part1.39.flatten.memory.bc'
...
for.inc54:                                        ; preds = %for.cond14.preheader, %for.body3.for.inc54_crit_edge
  ...
  br i1 %exitcond, label %for.inc57, label %for.body3, !dbg !392

for.inc57:                                        ; preds = %for.inc54
  %exitcond2 = icmp eq i32 %0, 512, !dbg !387
  br i1 %exitcond2, label %for.end59, label %for.cond1.preheader, !dbg !387
...
!414 = metadata !{i32 44, i32 1, metadata !4, null}
