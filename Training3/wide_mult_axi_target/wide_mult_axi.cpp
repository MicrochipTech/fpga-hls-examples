...
int main() {
    ...
    for (int i = 0; i < NUM_INPUTS; i++) {
        ...
        result(63, 32) = data.result1;
        result(95, 64) = data.result2;
        result(127, 96) = data.result3;
        result(159, 128) = data.result4;
        result(191, 160) = data.result5;
        result(223, 192) = data.result6;
