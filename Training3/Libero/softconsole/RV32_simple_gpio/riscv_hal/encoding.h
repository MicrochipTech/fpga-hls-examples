 ...
 *
 * SVN $Revision: 12760 $
 * SVN $Date: 2020-05-14 22:47:03 +0530 (Thu, 14 May 2020) $
 */
...
#define MSYS_E10IP          (1u << MSYS_E10)
#define MSYS_E11IP          (1u << MSYS_E11)
#define MSYS_E12IP          (1u << MSYS_E12)
#define MSYS_E13IP          (1u << MSYS_E13)
#define MSYS_E14IP          (1u << MSYS_E14)
#define MSYS_E15IP          (1u << MSYS_E15)
#define MSYS_EXTERNAL_INT   (0x3Fu << MSYS_E10)
#define MIP_OPSRV_REG       (1u << OPSRV_REG)
#define MIP_V7IP            (1u << IRQ_V7)
...
#define lmem0_ecc_err_correctable 1
#define lmem0_ecc_err_uncorrectable 2
#define lmem1_ecc_err_correctable 4
#define lmem1_ecc_err_uncorrectable 8
#define axi_err_irq 16

#define opsrv_reg_addr 0x1000
#define opsrv_reg_IE opsrv_reg_addr + 0x10
#define opsrv_reg_IP opsrv_reg_addr + 0x14
