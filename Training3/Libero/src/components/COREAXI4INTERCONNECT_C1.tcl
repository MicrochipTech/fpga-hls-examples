# Exporting Component Description of COREAXI4INTERCONNECT_C1 to TCL
# Family: PolarFire
...
"USER_WIDTH:1"   }
# Exporting Component Description of COREAXI4INTERCONNECT_C1 to TCL done
