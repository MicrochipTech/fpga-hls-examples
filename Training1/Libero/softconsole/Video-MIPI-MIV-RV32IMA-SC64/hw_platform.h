 ...
 */
#define SYS_CLK_FREQ                    50000000UL ///input clock frequncy to the MI-V
...
#define COREI2C_BASE_ADDR   	        0x70008000UL
#define FABRIC_BASE_ADDR             	0x70009000UL
#define CORESPI_BASE_ADDR               0x70006000UL



/*List of Fabric Addresses for register programming through APB*/
...
#define Frame_End_IRQn                  External_31_IRQn
#define I2C_CAM2_IRQn                   External_30_IRQn
#define I2C_CAM1_IRQn                   External_29_IRQn
#define HDMI_I2C_IRQn                   External_28_IRQn
