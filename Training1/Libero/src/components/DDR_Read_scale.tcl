...
# Add data_unpacker_scale_0 instance
sd_instantiate_hdl_module -sd_name ${sd_name} -hdl_module_name {data_unpacker_scale} -hdl_file {hdl\data_unpacker_scale.vhd} -instance_name {data_unpacker_scale_0}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:B" "DDR_read_controller_scale_0:reset_i" "data_unpacker_scale_0:reset_i" "reset_i" "synchronizer_circuit_0:reset_n" "synchronizer_circuit_1:reset_n" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_read_controller_scale_0:frame_active_o" "data_unpacker_scale_0:frame_active_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_read_controller_scale_0:read_en_i" "data_unpacker_scale_0:read_en_i" "read_en_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"bayer_dvalid_o" "data_unpacker_scale_0:data_valid_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_unpacker_scale_0:fifo_data_valid_i" "video_fifo_0:rdata_rdy_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_unpacker_scale_0:fifo_read_o" "video_fifo_0:ren_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_unpacker_scale_0:sys_clk_i" "disp_clk" "synchronizer_circuit_1:sys_clk" "video_fifo_0:rclock_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"bayer_data_o" "data_unpacker_scale_0:data_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"beats_to_read_o" "data_unpacker_scale_0:beats_to_read_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_unpacker_scale_0:data_i" "video_fifo_0:rdata_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_unpacker_scale_0:h_shift_i" "h_shift_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_unpacker_scale_0:horz_resl_i" "horz_resl_i" }
