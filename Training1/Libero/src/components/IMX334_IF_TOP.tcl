...
sd_create_scalar_port -sd_name ${sd_name} -port_name {c2_frame_start_o} -port_direction {OUT}
sd_create_scalar_port -sd_name ${sd_name} -port_name {c2_frame_valid_o} -port_direction {OUT}
sd_create_scalar_port -sd_name ${sd_name} -port_name {c2_line_valid_o} -port_direction {OUT}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {c1_data_out_o} -port_direction {OUT} -port_range {[31:0]}
sd_create_bus_port -sd_name ${sd_name} -port_name {c2_data_out_o} -port_direction {OUT} -port_range {[31:0]}


sd_create_pin_slices -sd_name ${sd_name} -pin_name {c1_data_out_o} -pin_slices {[15:8]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {c1_data_out_o} -pin_slices {[23:16]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {c1_data_out_o} -pin_slices {[31:24]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {c1_data_out_o} -pin_slices {[7:0]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {c2_data_out_o} -pin_slices {[15:8]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {c2_data_out_o} -pin_slices {[23:16]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {c2_data_out_o} -pin_slices {[31:24]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {c2_data_out_o} -pin_slices {[7:0]}
# Add AND2_0 instance
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERESET_PF_C2_0:BANK_y_VDDI_STATUS} -value {GND}
...
sd_create_pin_slices -sd_name ${sd_name} -pin_name {CSI2_RXDecoder_0:data_out_o} -pin_slices {[19:12]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {CSI2_RXDecoder_0:data_out_o} -pin_slices {[29:22]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {CSI2_RXDecoder_0:data_out_o} -pin_slices {[39:32]}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:B" "CORERESET_PF_C1_0:PLL_LOCK" "CORERESET_PF_C2_0:PLL_LOCK" "CORERESET_PF_C3_0:PLL_LOCK" "PF_CCC_C2_0:PLL_LOCK_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:Y" "PF_IOD_GENERIC_RX_C0_0:TRAINING_RESETN" "PF_IOD_GENERIC_RX_C0_1:TRAINING_RESETN" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_1:A" "PF_IOD_GENERIC_RX_C0_1:training_done_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_1:B" "PF_IOD_GENERIC_RX_C0_0:training_done_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_1:Y" "CORERESET_PF_C1_0:EXT_RST_N" "CORERESET_PF_C2_0:EXT_RST_N" "CORERESET_PF_C3_0:EXT_RST_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ARST_N" "PF_IOD_GENERIC_RX_C0_0:ARST_N" "PF_IOD_GENERIC_RX_C0_1:ARST_N" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C1_0:CLK" "CSI2_RXDecoder_0:PARALLEL_CLOCK_I" "CSI2_RXDecoder_1:PARALLEL_CLOCK_I" "PARALLEL_CLOCK" "PF_CCC_C2_0:OUT0_FABCLK_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C1_0:INIT_DONE" "CORERESET_PF_C2_0:INIT_DONE" "CORERESET_PF_C3_0:INIT_DONE" "INIT_DONE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C2_0:FABRIC_RESET_N" "CSI2_RXDecoder_0:RESET_n_I" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C3_0:CLK" "CSI2_RXDecoder_1:CAM_CLOCK_I" "PF_IOD_GENERIC_RX_C0_1:RX_CLK_G" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CSI2_RXDecoder_1:frame_start_o" "c2_frame_start_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CSI2_RXDecoder_1:frame_valid_o" "c2_frame_valid_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CSI2_RXDecoder_1:line_valid_o" "c2_line_valid_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CSI2_RXDecoder_0:data_out_o[19:12]" "c1_data_out_o[15:8]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CSI2_RXDecoder_0:data_out_o[29:22]" "c1_data_out_o[23:16]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CSI2_RXDecoder_0:data_out_o[39:32]" "c1_data_out_o[31:24]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CSI2_RXDecoder_0:data_out_o[9:2]" "c1_data_out_o[7:0]" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CSI2_RXDecoder_1:data_out_o[19:12]" "c2_data_out_o[15:8]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CSI2_RXDecoder_1:data_out_o[29:22]" "c2_data_out_o[23:16]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CSI2_RXDecoder_1:data_out_o[39:32]" "c2_data_out_o[31:24]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CSI2_RXDecoder_1:data_out_o[9:2]" "c2_data_out_o[7:0]" }
