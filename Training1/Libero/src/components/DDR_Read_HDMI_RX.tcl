# Creating SmartDesign DDR_Read_HDMI_RX
set sd_name {DDR_Read_HDMI_RX}
...
# Add data_unpacker_HDMI_RX_0 instance
sd_instantiate_hdl_module -sd_name ${sd_name} -hdl_module_name {data_unpacker_HDMI_RX} -hdl_file {hdl\data_unpacker_HDMI_RX.vhd} -instance_name {data_unpacker_HDMI_RX_0}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {data_unpacker_HDMI_RX_0:alpha_o}



# Add DDR_read_controller_HDMI_RX_0 instance
sd_instantiate_hdl_module -sd_name ${sd_name} -hdl_module_name {DDR_read_controller_HDMI_RX} -hdl_file {hdl\DDR_read_controller_HDMI_RX.vhd} -instance_name {DDR_read_controller_HDMI_RX_0}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:A" "DDR_read_controller_HDMI_RX_0:reset_i" "data_unpacker_HDMI_RX_0:reset_i" "reset_i" "synchronizer_circuit_0:reset_n" "synchronizer_circuit_1:reset_n" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:B" "DDR_read_controller_HDMI_RX_0:frame_end_i" "frame_end_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:Y" "synchronizer_circuit_0:data_in" "synchronizer_circuit_1:data_in" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_read_controller_HDMI_RX_0:read_ackn_i" "read_ackn_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_read_controller_HDMI_RX_0:read_done_i" "read_done_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_read_controller_HDMI_RX_0:read_en_i" "data_unpacker_HDMI_RX_0:read_en_i" "read_en_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_read_controller_HDMI_RX_0:read_req_o" "read_req_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_read_controller_HDMI_RX_0:sys_clk_i" "synchronizer_circuit_1:sys_clk" "sys_clk_i" "video_fifo_0:wclock_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"bayer_dvalid_o" "data_unpacker_HDMI_RX_0:data_valid_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_unpacker_HDMI_RX_0:disp_clk_i" "disp_clk_i" "synchronizer_circuit_0:sys_clk" "video_fifo_0:rclock_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_unpacker_HDMI_RX_0:fifo_data_valid_i" "video_fifo_0:rdata_rdy_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_unpacker_HDMI_RX_0:fifo_read_o" "video_fifo_0:ren_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ddr_data_valid_i" "video_fifo_0:wen_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"synchronizer_circuit_0:sync_out" "video_fifo_0:rresetn_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"synchronizer_circuit_1:sync_out" "video_fifo_0:wresetn_i" }

# Add bus net connections
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_read_controller_HDMI_RX_0:frame_start_addr_i" "frame_start_addr_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_read_controller_HDMI_RX_0:h_pan_i" "h_pan_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_read_controller_HDMI_RX_0:read_start_addr_o" "read_start_addr_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_read_controller_HDMI_RX_0:v_pan_i" "v_pan_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"beats_to_read_o" "data_unpacker_HDMI_RX_0:beats_to_read_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"blue_o" "data_unpacker_HDMI_RX_0:blue_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_unpacker_HDMI_RX_0:data_i" "video_fifo_0:rdata_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_unpacker_HDMI_RX_0:green_o" "green_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_unpacker_HDMI_RX_0:horz_resl_i" "horz_resl_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_unpacker_HDMI_RX_0:red_o" "red_o" }
...
# Generate SmartDesign DDR_Read_HDMI_RX
