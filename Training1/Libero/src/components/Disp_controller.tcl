...
sd_create_scalar_port -sd_name ${sd_name} -port_name {ENABLE_I_0} -port_direction {IN}
sd_create_scalar_port -sd_name ${sd_name} -port_name {EXT_SYNC_SIGNAL_I_0} -port_direction {IN}
...
sd_create_scalar_port -sd_name ${sd_name} -port_name {DATA_ENABLE_O_0} -port_direction {OUT}
sd_create_scalar_port -sd_name ${sd_name} -port_name {DATA_ENABLE_O} -port_direction {OUT}
sd_create_scalar_port -sd_name ${sd_name} -port_name {DATA_TRIGGER_O_0} -port_direction {OUT}
sd_create_scalar_port -sd_name ${sd_name} -port_name {DATA_TRIGGER_O} -port_direction {OUT}
sd_create_scalar_port -sd_name ${sd_name} -port_name {FRAME_END_O_0} -port_direction {OUT}
sd_create_scalar_port -sd_name ${sd_name} -port_name {FRAME_END_O} -port_direction {OUT}
sd_create_scalar_port -sd_name ${sd_name} -port_name {H_SYNC_O_0} -port_direction {OUT}
sd_create_scalar_port -sd_name ${sd_name} -port_name {H_SYNC_O} -port_direction {OUT}
sd_create_scalar_port -sd_name ${sd_name} -port_name {V_SYNC_O_0} -port_direction {OUT}
sd_create_scalar_port -sd_name ${sd_name} -port_name {V_SYNC_O} -port_direction {OUT}


# Create top level Bus Ports
sd_create_bus_port -sd_name ${sd_name} -port_name {H_RES_O_0} -port_direction {OUT} -port_range {[15:0]}
...
# Add Display_Controller_C1_0 instance
sd_instantiate_component -sd_name ${sd_name} -component_name {Display_Controller_C1} -instance_name {Display_Controller_C1_0}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {Display_Controller_C1_0:ENABLE_EXT_SYNC_I} -value {VCC}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {Display_Controller_C1_0:H_ACTIVE_O}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {Display_Controller_C1_0:V_ACTIVE_O}



# Add scalar net connections
sd_connect_pins -sd_name ${sd_name} -pin_names {"DATA_ENABLE_O" "Display_Controller_C0_0:DATA_ENABLE_O" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DATA_ENABLE_O_0" "Display_Controller_C1_0:DATA_ENABLE_O" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DATA_TRIGGER_O" "Display_Controller_C0_0:DATA_TRIGGER_O" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DATA_TRIGGER_O_0" "Display_Controller_C1_0:DATA_TRIGGER_O" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Display_Controller_C1_0:ENABLE_I" "ENABLE_I_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Display_Controller_C1_0:EXT_SYNC_SIGNAL_I" "EXT_SYNC_SIGNAL_I_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Display_Controller_C1_0:FRAME_END_O" "FRAME_END_O_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Display_Controller_C1_0:H_SYNC_O" "H_SYNC_O_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Display_Controller_C1_0:RESETN_I" "RESETN_I_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Display_Controller_C1_0:SYS_CLK_I" "SYS_CLK_I_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Display_Controller_C1_0:V_SYNC_O" "V_SYNC_O_0" }

# Add bus net connections
sd_connect_pins -sd_name ${sd_name} -pin_names {"Display_Controller_C0_0:H_RES_O" "H_RES_O" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Display_Controller_C1_0:H_RES_O" "H_RES_O_0" }
