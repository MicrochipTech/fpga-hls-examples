...
sd_create_scalar_port -sd_name ${sd_name} -port_name {sclk_raw} -port_direction {IN}
...
sd_create_pin_slices -sd_name ${sd_name} -pin_name {GPIO_OUT_0} -pin_slices {[0:0]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {GPIO_OUT_0} -pin_slices {[3:1]}
...
sd_create_pin_slices -sd_name ${sd_name} -pin_name {HDMI:DATA_B_I} -pin_slices {[15:8]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {HDMI:DATA_B_I} -pin_slices {[23:16]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {HDMI:DATA_B_I} -pin_slices {[31:24]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {HDMI:DATA_B_I} -pin_slices {[7:0]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {HDMI:DATA_G_I} -pin_slices {[15:8]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {HDMI:DATA_G_I} -pin_slices {[23:16]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {HDMI:DATA_G_I} -pin_slices {[31:24]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {HDMI:DATA_G_I} -pin_slices {[7:0]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {HDMI:DATA_R_I} -pin_slices {[15:8]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {HDMI:DATA_R_I} -pin_slices {[23:16]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {HDMI:DATA_R_I} -pin_slices {[31:24]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {HDMI:DATA_R_I} -pin_slices {[7:0]}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {Memory_Read_0:v_pan_i_1} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {Memory_Read_0:h_pan_i_1} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {Memory_Read_0:h_pan_i_2} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {Memory_Read_0:v_pan_i_2} -value {GND}
...
sd_create_pin_slices -sd_name ${sd_name} -pin_name {Memory_Write_0:data_i} -pin_slices {[15:8]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {Memory_Write_0:data_i} -pin_slices {[23:16]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {Memory_Write_0:data_i} -pin_slices {[31:24]}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {Memory_Write_0:data_i[31:24]} -value {GND}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {Memory_Write_0:data_i} -pin_slices {[7:0]}
...
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:DATA_I_1} -pin_slices {[15:8]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:DATA_I_1} -pin_slices {[23:16]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:DATA_I_1} -pin_slices {[31:24]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:DATA_I_1} -pin_slices {[7:0]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:DATA_O} -pin_slices {[15:8]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:DATA_O} -pin_slices {[23:16]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:DATA_O} -pin_slices {[7:0]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:DATA_O_0} -pin_slices {[15:8]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:DATA_O_0} -pin_slices {[23:16]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:DATA_O_0} -pin_slices {[7:0]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:DATA_O_1} -pin_slices {[15:8]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:DATA_O_1} -pin_slices {[23:16]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:DATA_O_1} -pin_slices {[7:0]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:DATA_O_2} -pin_slices {[15:8]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:DATA_O_2} -pin_slices {[23:16]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:DATA_O_2} -pin_slices {[7:0]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:input1_i} -pin_slices {[15:8]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:input1_i} -pin_slices {[23:16]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {video_pipelining_0:input1_i} -pin_slices {[7:0]}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CCC_0:OUT0_FABCLK_0" "HDMI:EDID_CLK_I" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CCC_0:OUT0_FABCLK_0_0" "Disp_controller_0:SYS_CLK_I" "Memory_Read_0:disp_clk" "Memory_Read_0:disp_clk_i" "Memory_Read_0:disp_clk_i_1" "Reset_0:CLK_1" "hdmi_clk" "video_pipelining_0:SYS_CLK_I" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CCC_0:REF_CLK_0_0" "Memory_Read_0:sys_clk_i" "Memory_Write_0:ddr_clk_i" "Memory_Write_0:ddr_clock_i" "Memory_Write_0:ddr_clock_i_0" "PF_DDR4_C0_0:SYS_CLK" "Reset_0:CLK_0" "Video_arbiter_top_0:sys_clk_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Disp_controller_0:DATA_ENABLE_O_0" "HDMI:DATA_VALID_I" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Disp_controller_0:DATA_TRIGGER_O" "Memory_Read_0:read_en_i" "Memory_Read_0:read_en_i_0" "Memory_Read_0:read_en_i_2" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Disp_controller_0:DATA_TRIGGER_O_0" "Memory_Read_0:read_en_i_1" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Disp_controller_0:ENABLE_I_0" "HDMI:LANE0_TX_CLK_STABLE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Disp_controller_0:EXT_SYNC_SIGNAL_I" "video_pipelining_0:DATA_VALID_O" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Disp_controller_0:EXT_SYNC_SIGNAL_I_0" "video_pipelining_0:RGB_VALID_O" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Disp_controller_0:FRAME_END_O" "Memory_Read_0:frame_end_i" "Memory_Read_0:frame_end_i_0" "Memory_Read_0:frame_end_i_2" "video_pipelining_0:eof_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Disp_controller_0:FRAME_END_O_0" "Memory_Read_0:frame_end_i_1" "video_pipelining_0:EOF_I_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Disp_controller_0:H_SYNC_O" "horz_sync_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Disp_controller_0:H_SYNC_O_0" "HDMI:H_SYNC_I" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Disp_controller_0:RESETN_I_0" "HDMI:RESET_N_I_0" "Reset_0:FABRIC_RESET_N_0" "video_pipelining_0:RESETN_I_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Disp_controller_0:SYS_CLK_I_0" "HDMI:LANE0_TX_CLK_R" "Memory_Read_0:disp_clk_i_0" "Reset_0:CLK" "video_pipelining_0:SYS_CLK_I_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Disp_controller_0:V_SYNC_O" "vert_sync_o" "video_pipelining_0:vsync_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Disp_controller_0:V_SYNC_O_0" "HDMI:V_SYNC_I" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"GPIO_OUT_0[0:0]" "PROC_SUBSYSTEM_0:GPIO_OUT_0[0:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:DATA_VALID_O" "Memory_Write_0:data_valid_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:HPD_I" "HPD_I" "video_pipelining_0:data_in" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:HPD_O" "HPD_O" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:LANE3_RX_CLK_R" "Memory_Write_0:parallel_clk_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:RESET_N_I" "Reset_0:DEVICE_INIT_DONE" "video_pipelining_0:A_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:SCL_I" "sclk_raw" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:SDA" "SDA" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:V_SYNC_O" "Memory_Write_0:frame_valid_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:bayer_dvalid_o_1" "video_pipelining_0:DATA_VALID_I_1" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:bayer_dvalid_o_2" "video_pipelining_0:hdmi_valid" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:ddr_data_valid_i_1" "Video_arbiter_top_0:r2_data_valid_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:ddr_data_valid_i_2" "Video_arbiter_top_0:r3_data_valid_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:read_ackn_i_1" "Video_arbiter_top_0:r2_ack_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:read_ackn_i_2" "Video_arbiter_top_0:r3_ack_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:read_done_i_1" "Video_arbiter_top_0:r2_done_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:read_done_i_2" "Video_arbiter_top_0:r3_done_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:read_req_o_1" "Video_arbiter_top_0:r2_req_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:read_req_o_2" "Video_arbiter_top_0:r3_req_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Write_0:rdata_rdy_o" "Video_arbiter_top_0:w2_data_valid_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Write_0:write_ackn_i" "Video_arbiter_top_0:w2_ack_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Write_0:write_done_i" "Video_arbiter_top_0:w2_done_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Write_0:write_req_o" "Video_arbiter_top_0:w2_req_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"UART_interface_0:bayer_edge_sel_o" "video_pipelining_0:selection_line_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"UART_interface_0:pip_mode_sel_o" "video_pipelining_0:mode_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"toggle" "video_pipelining_0:toggle" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Disp_controller_0:H_RES_O" "Memory_Read_0:horz_resl_i" "Memory_Read_0:horz_resl_i_0" "Memory_Read_0:horz_resl_i_2" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Disp_controller_0:H_RES_O_0" "Memory_Read_0:horz_resl_i_1" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"GPIO_OUT_0[3:1]" "video_pipelining_0:onehot_filter_state" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"G_out_o" "video_pipelining_0:G_out_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:B_O" "Memory_Write_0:data_i[7:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:DATA_B_I[15:8]" "video_pipelining_0:DATA_O_1[7:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:DATA_B_I[23:16]" "video_pipelining_0:DATA_O_2[7:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:DATA_B_I[31:24]" "video_pipelining_0:DATA_O[7:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:DATA_B_I[7:0]" "video_pipelining_0:DATA_O_0[7:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:DATA_G_I[15:8]" "video_pipelining_0:DATA_O_1[15:8]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:DATA_G_I[23:16]" "video_pipelining_0:DATA_O_2[15:8]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:DATA_G_I[31:24]" "video_pipelining_0:DATA_O[15:8]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:DATA_G_I[7:0]" "video_pipelining_0:DATA_O_0[15:8]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:DATA_R_I[15:8]" "video_pipelining_0:DATA_O_1[23:16]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:DATA_R_I[23:16]" "video_pipelining_0:DATA_O_2[23:16]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:DATA_R_I[31:24]" "video_pipelining_0:DATA_O[23:16]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:DATA_R_I[7:0]" "video_pipelining_0:DATA_O_0[23:16]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:G_O" "Memory_Write_0:data_i[15:8]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"HDMI:R_O" "Memory_Write_0:data_i[23:16]" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:beats_to_read_o_1" "Video_arbiter_top_0:r2_burst_size_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:beats_to_read_o_2" "Video_arbiter_top_0:r3_burst_size_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:blue_o" "video_pipelining_0:input1_i[7:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:data_o" "video_pipelining_0:DATA_I_1[31:24]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:data_o_0" "video_pipelining_0:DATA_I_1[23:16]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:data_o_1" "video_pipelining_0:DATA_I_1[7:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:data_o_2" "video_pipelining_0:DATA_I_1[15:8]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:frame_start_addr_i" "Memory_Read_0:frame_start_addr_i_1" "video_pipelining_0:frame_start_address1_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:frame_start_addr_i_0" "video_pipelining_0:frame_start_address2_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:frame_start_addr_i_2" "Memory_Write_0:display_frame_addr_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:green_o" "video_pipelining_0:input1_i[15:8]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:h_pan_i" "UART_interface_0:h_pan_c1_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:h_pan_i_0" "UART_interface_0:h_pan_c2_o" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:read_start_addr_o_1" "Video_arbiter_top_0:r2_rstart_addr_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:read_start_addr_o_2" "Video_arbiter_top_0:r3_rstart_addr_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:red_o" "video_pipelining_0:input1_i[23:16]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:v_pan_i" "UART_interface_0:v_pan_c1_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:v_pan_i_0" "UART_interface_0:v_pan_c2_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:v_shift_i" "video_pipelining_0:v_shift_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Read_0:wdata_i" "Memory_Read_0:wdata_i_0" "Memory_Read_0:wdata_i_1" "Memory_Read_0:wdata_i_2" "Video_arbiter_top_0:rdata_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Write_0:beats_to_write_o" "Video_arbiter_top_0:w2_burst_size_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Write_0:rdata_o" "Video_arbiter_top_0:w2_data_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Memory_Write_0:write_start_addr_o" "Video_arbiter_top_0:w2_wstart_addr_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"UART_interface_0:bayer_format2_o" "video_pipelining_0:BAYER_FORMAT_1" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"switches_readdata" "video_pipelining_0:switches_readdata" }
