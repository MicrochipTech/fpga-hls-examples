...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {DDR_Write_HDMI_RX_0:frame_ddr_addr_i} -value {00001000}



# Add scalar net connections
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_Write_0:data_valid_i" "data_valid_i_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_Write_0:ddr_clk_rst" "DDR_Write_1:ddr_clk_rst" "DDR_Write_HDMI_RX_0:reset_i" "reset_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_Write_HDMI_RX_0:data_valid_i" "data_valid_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_Write_HDMI_RX_0:ddr_clk_i" "ddr_clk_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_Write_HDMI_RX_0:frame_valid_i" "frame_valid_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_Write_HDMI_RX_0:parallel_clk_i" "parallel_clk_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_Write_HDMI_RX_0:data_i" "data_i" }
