# Creating SmartDesign DDR_Write_HDMI_RX
set sd_name {DDR_Write_HDMI_RX}
...
# Add data_packer_HDMI_RX_0 instance
sd_instantiate_hdl_module -sd_name ${sd_name} -hdl_module_name {data_packer_HDMI_RX} -hdl_file {hdl\data_packer_HDMI_RX.vhd} -instance_name {data_packer_HDMI_RX_0}



# Add DDR_write_controller_HDMI_RX_0 instance
sd_instantiate_hdl_module -sd_name ${sd_name} -hdl_module_name {DDR_write_controller_HDMI_RX} -hdl_file {hdl\DDR_write_controller_HDMI_RX.vhd} -instance_name {DDR_write_controller_HDMI_RX_0}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:A" "DDR_write_controller_HDMI_RX_0:reset_i" "data_packer_HDMI_RX_0:reset_i" "reset_i" "synchronizer_circuit_0:reset_n" "synchronizer_circuit_1:reset_n" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:B" "data_packer_HDMI_RX_0:fifo_reset_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:Y" "synchronizer_circuit_0:data_in" "synchronizer_circuit_1:data_in" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_HDMI_RX_0:frame_valid_i" "data_packer_HDMI_RX_0:frame_valid_i" "frame_valid_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_HDMI_RX_0:read_fifo_o" "video_fifo_0:ren_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_HDMI_RX_0:start_i" "data_packer_HDMI_RX_0:start_ddr_w_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_HDMI_RX_0:sys_clk_i" "ddr_clk_i" "synchronizer_circuit_1:sys_clk" "video_fifo_0:rclock_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_HDMI_RX_0:write_ackn_i" "write_ackn_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_HDMI_RX_0:write_done_i" "write_done_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_HDMI_RX_0:write_req_o" "write_req_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_packer_HDMI_RX_0:data_valid_i" "data_valid_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_packer_HDMI_RX_0:data_valid_o" "video_fifo_0:wen_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_packer_HDMI_RX_0:sys_clk_i" "parallel_clk_i" "synchronizer_circuit_0:sys_clk" "video_fifo_0:wclock_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_HDMI_RX_0:display_frame_addr_o" "display_frame_addr_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_HDMI_RX_0:frame_ddr_addr_i" "frame_ddr_addr_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_HDMI_RX_0:horiz_resolution_i" "data_packer_HDMI_RX_0:h_count_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_HDMI_RX_0:write_length_o" "beats_to_write_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_write_controller_HDMI_RX_0:write_start_addr_o" "write_start_addr_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_i" "data_packer_HDMI_RX_0:data_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"data_packer_HDMI_RX_0:data_o" "video_fifo_0:wdata_i" }
...
# Generate SmartDesign DDR_Write_HDMI_RX
