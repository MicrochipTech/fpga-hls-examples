...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_Read_0:reset_i" "DDR_Read_scale_0:reset_i" "reset_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_Read_0:sys_clk_i" "DDR_Read_scale_0:sys_clk_i" "sys_clk_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"DDR_Read_0:frame_start_addr_i" "DDR_Read_scale_0:frame_start_addr_i" "frame_start_addr_i" }
