...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C0_0:PLL_LOCK} -value {VCC}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C0_0:BIT_ALGN_EYE_IN} -value {001}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C0_0:DEM_CLK_ALGN_TAPDLY}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C1_0:PLL_LOCK} -value {VCC}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C1_0:BIT_ALGN_EYE_IN} -value {001}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C1_0:DEM_CLK_ALGN_TAPDLY}



# Add CORERXIODBITALIGN_C2_0 instance
sd_instantiate_component -sd_name ${sd_name} -component_name {CORERXIODBITALIGN_C2} -instance_name {CORERXIODBITALIGN_C2_0}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C2_0:PLL_LOCK} -value {VCC}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C2_0:BIT_ALGN_START}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C2_0:BIT_ALGN_OOR}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C2_0:BIT_ALGN_HOLD} -value {GND}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C2_0:BIT_ALGN_ERR}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C2_0:BIT_ALGN_EYE_IN} -value {001}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C2_0:DEM_CLK_ALGN_TAPDLY}



# Add CORERXIODBITALIGN_C3_0 instance
sd_instantiate_component -sd_name ${sd_name} -component_name {CORERXIODBITALIGN_C3} -instance_name {CORERXIODBITALIGN_C3_0}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C3_0:PLL_LOCK} -value {VCC}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C3_0:BIT_ALGN_START}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C3_0:BIT_ALGN_OOR}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C3_0:BIT_ALGN_HOLD} -value {GND}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C3_0:BIT_ALGN_ERR}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C3_0:BIT_ALGN_EYE_IN} -value {001}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERXIODBITALIGN_C3_0:DEM_CLK_ALGN_TAPDLY}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:Y" "CORERXIODBITALIGN_C0_0:RESETN" "CORERXIODBITALIGN_C1_0:RESETN" "CORERXIODBITALIGN_C2_0:RESETN" "CORERXIODBITALIGN_C3_0:RESETN" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND4_0:A" "CORERXIODBITALIGN_C0_0:BIT_ALGN_DONE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND4_0:B" "CORERXIODBITALIGN_C1_0:BIT_ALGN_DONE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND4_0:C" "CORERXIODBITALIGN_C2_0:BIT_ALGN_DONE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND4_0:D" "CORERXIODBITALIGN_C3_0:BIT_ALGN_DONE" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C1_0:CLK" "CORERXIODBITALIGN_C0_0:SCLK" "CORERXIODBITALIGN_C1_0:SCLK" "CORERXIODBITALIGN_C2_0:SCLK" "CORERXIODBITALIGN_C3_0:SCLK" "PF_IOD_0:RX_CLK_G" "RX_CLK_G" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C1_0:EXT_RST_N" "TRAINING_RESETN" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C0_0:BIT_ALGN_CLR_FLGS" "PF_IOD_0:EYE_MONITOR_CLEAR_FLAGS[0:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C0_0:BIT_ALGN_DIR" "PF_IOD_0:DELAY_LINE_DIRECTION[0:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C0_0:BIT_ALGN_LOAD" "PF_IOD_0:DELAY_LINE_LOAD[0:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C0_0:BIT_ALGN_MOVE" "PF_IOD_0:DELAY_LINE_MOVE[0:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C0_0:BIT_ALGN_RSTRT" "CORERXIODBITALIGN_C1_0:BIT_ALGN_RSTRT" "CORERXIODBITALIGN_C2_0:BIT_ALGN_RSTRT" "CORERXIODBITALIGN_C3_0:BIT_ALGN_RSTRT" "RESTART_TRNG" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C0_0:BIT_ALGN_SKIP" "CORERXIODBITALIGN_C1_0:BIT_ALGN_SKIP" "CORERXIODBITALIGN_C2_0:BIT_ALGN_SKIP" "CORERXIODBITALIGN_C3_0:BIT_ALGN_SKIP" "SKIP_TRNG" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C0_0:IOD_EARLY" "PF_IOD_0:EYE_MONITOR_EARLY[0:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C0_0:IOD_LATE" "PF_IOD_0:EYE_MONITOR_LATE[0:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C0_0:IOD_OOR" "PF_IOD_0:DELAY_LINE_OUT_OF_RANGE[0:0]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C0_0:LP_IN" "L0_LP_DATA_N" "PF_IOD_0:L0_LP_DATA_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C1_0:BIT_ALGN_CLR_FLGS" "PF_IOD_0:EYE_MONITOR_CLEAR_FLAGS[1:1]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C1_0:BIT_ALGN_DIR" "PF_IOD_0:DELAY_LINE_DIRECTION[1:1]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C1_0:BIT_ALGN_LOAD" "PF_IOD_0:DELAY_LINE_LOAD[1:1]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C1_0:BIT_ALGN_MOVE" "PF_IOD_0:DELAY_LINE_MOVE[1:1]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C1_0:IOD_EARLY" "PF_IOD_0:EYE_MONITOR_EARLY[1:1]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C1_0:IOD_LATE" "PF_IOD_0:EYE_MONITOR_LATE[1:1]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C1_0:IOD_OOR" "PF_IOD_0:DELAY_LINE_OUT_OF_RANGE[1:1]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C1_0:LP_IN" "L1_LP_DATA_N" "PF_IOD_0:L1_LP_DATA_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C2_0:BIT_ALGN_CLR_FLGS" "PF_IOD_0:EYE_MONITOR_CLEAR_FLAGS[2:2]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C2_0:BIT_ALGN_DIR" "PF_IOD_0:DELAY_LINE_DIRECTION[2:2]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C2_0:BIT_ALGN_LOAD" "PF_IOD_0:DELAY_LINE_LOAD[2:2]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C2_0:BIT_ALGN_MOVE" "PF_IOD_0:DELAY_LINE_MOVE[2:2]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C2_0:IOD_EARLY" "PF_IOD_0:EYE_MONITOR_EARLY[2:2]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C2_0:IOD_LATE" "PF_IOD_0:EYE_MONITOR_LATE[2:2]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C2_0:IOD_OOR" "PF_IOD_0:DELAY_LINE_OUT_OF_RANGE[2:2]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C2_0:LP_IN" "L2_LP_DATA_N" "PF_IOD_0:L2_LP_DATA_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C3_0:BIT_ALGN_CLR_FLGS" "PF_IOD_0:EYE_MONITOR_CLEAR_FLAGS[3:3]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C3_0:BIT_ALGN_DIR" "PF_IOD_0:DELAY_LINE_DIRECTION[3:3]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C3_0:BIT_ALGN_LOAD" "PF_IOD_0:DELAY_LINE_LOAD[3:3]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C3_0:BIT_ALGN_MOVE" "PF_IOD_0:DELAY_LINE_MOVE[3:3]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C3_0:IOD_EARLY" "PF_IOD_0:EYE_MONITOR_EARLY[3:3]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C3_0:IOD_LATE" "PF_IOD_0:EYE_MONITOR_LATE[3:3]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C3_0:IOD_OOR" "PF_IOD_0:DELAY_LINE_OUT_OF_RANGE[3:3]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERXIODBITALIGN_C3_0:LP_IN" "L3_LP_DATA_N" "PF_IOD_0:L3_LP_DATA_N" }
