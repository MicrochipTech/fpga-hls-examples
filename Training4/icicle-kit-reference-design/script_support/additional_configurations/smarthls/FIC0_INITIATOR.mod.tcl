# This file is essentially a copy of this file:
#
#   script_support/components/FIC0_INITIATOR.tcl
#
#  with the following modifications:
#
#  - Added one extra slave port
#
configure_core -component_name {FIC0_INITIATOR} -params { \
    "ADDR_WIDTH:38" \
    "CROSSBAR_MODE:0" \
    "DATA_WIDTH:64" \
...
"SLAVE0_END_ADDR:0x60001fff"  \
"SLAVE0_END_ADDR_UPPER:0x0"  \
    "SLAVE0_READ_INTERLEAVE:false" \
"SLAVE0_START_ADDR:0x60001000"  \
...
"SLAVE1_START_ADDR:0x60000000"  \
    ...
    "SLAVE2_END_ADDR:0x707FFFFF" \
    "SLAVE2_END_ADDR_UPPER:0x0" \
    "SLAVE2_READ_INTERLEAVE:false" \
    "SLAVE2_START_ADDR:0x70000000" \
    ...
    "SLAVE3_END_ADDR:0x707FFFFF" \
    "SLAVE3_END_ADDR_UPPER:0x0" \
    "SLAVE3_READ_INTERLEAVE:false" \
    "SLAVE3_START_ADDR:0x70000000" \
