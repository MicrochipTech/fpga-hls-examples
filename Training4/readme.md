...
`SmartHLS_Training4_Jobs_2024.1` folder downloaded in section 3.3.
...
precompiled .job file in the Jobs folder `SmartHLS_Training4_Jobs_2024.1\INVERT_AND_THRESHOLD_SIMPLE.job`.
...
`SmartHLS_Training4_Jobs_2024.1` folder on Github.
...
precompiled bitstream in `SmartHLS_Training4_Jobs_2024.1` folder on Github.
